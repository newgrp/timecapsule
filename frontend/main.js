...
import { base64Decode, base64Encode, utf8Decode, utf8Encode } from "./modules/bytes.js"
...
document.getElementsByName("datetime").forEach(
    (menu) => menu.value = dayjs().format("YYYY-MM-DDTHH:mm:ss")
)
...
Intl.supportedValuesOf("timeZone").forEach(tz => {
    ...
    tzSelects.forEach((menu) => menu.appendChild(new Option(
        /*text=*/tz,
        /*value=*/tz,
...
document
    ...
    .addEventListener("click", function (e) {
        ...
        encryptMessage(message, datetime).catch((e) => {
            console.error(e)
        }).then((result) => {
...
document
    ...
    .addEventListener("click", function (e) {
        ...
        decryptMessage(encryptedMessage, datetime).catch((e) => {
            console.error(e)
        }).then((result) => {
